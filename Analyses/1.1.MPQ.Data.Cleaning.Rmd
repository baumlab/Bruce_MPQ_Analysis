...
mpq1 <- subset(mpq1, select = c ("year.site.ppq", "DEM", "area_2d", "area_3d", "rug", "vrm", "curv", "pro.curv", "plan.curv", "year",  "hum_dist","region",  "pub.site", "site","site.ppq","ppq"))
...
mpq2 <- mpq1[order(mpq1$year.site.ppq),]
row.names(mpq2) <- 1:nrow(mpq2) #Changes the row names so that they are re-orderd 1-80


mpq.1 <- subset(mpq2, DEM ==1) #1cm DEM
row.names(mpq.1) <- 1:nrow(mpq.1) #Changes the row names so that they are re-orderd 1-80

mpq.4 <- subset(mpq2, DEM ==4) #4cm DEM
row.names(mpq.4) <- 1:nrow(mpq.4) #Changes the row names so that they are re-orderd 1-80

mpq.8 <- subset(mpq2, DEM ==8) #8cm DEM
