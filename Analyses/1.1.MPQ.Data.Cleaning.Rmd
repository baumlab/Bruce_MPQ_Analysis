...
CC.total$timepoint <- factor(CC.total$timepoint, levels =c("A", "B", "C"), labels = c("2015-2017", "2017-2019", "2015-2019"))
CC.total
...
colnames(CC.final)
CC.final <- subset(CC.final, select = c("pub.site", "site", "ppq", "hum_dist", "hdist.cont","sqrt.hdist.cont", "island.side", "region.3", "region.4", "region.full", "timepoint", "volume.change"))

#Export Clean Data as a csv
write.csv(CC.final, "~/Desktop/GitHub/Bruce_MPQ_Analysis/Data/BaumLab_CloudCompare_Data_Clean_Updated.csv")
```
...
#Take a subset of the mpq data to only include 2015, 2017, 2019 years
mpq1<- subset(mpq, year == 2015 | year == 2017 | year == 2019)
mpq1 <- subset(mpq1, select = c("year", "DEM", "area_2d", "area_3d", "rug", "vrm", "curv", "pro.curv", "plan.curv", "hum_dist", "pub.site", "site","ppq"))

#Line up rows with digitization dataframe
#levels(mpq1$year.site.ppq)
#mpq1$year.site.ppq<- factor(mpq1$year.site.ppq, levels = c("2015.27.1", "2015.27.2", "2015.27.3", "2015.30.1", "2015.30.2", "2015.30.3", "2015.32.1", "2015.32.2", "2015.32.3", "2015.8.1", "2015.8.2", "2015.8.3", "2015.34.1", "2015.34.2", "2015.34.3", "2015.35.1", "2015.35.2", "2015.35.3", "2015.15.1", "2015.15.2", "2015.15.3", "2015.19.1", "2015.19.2", "2015.5.1", "2015.5.2", "2015.5.3", "2017.27.1", "2017.27.2", "2017.27.3", "2017.30.1", "2017.30.2", "2017.30.3", "2017.32.1", "2017.32.2", "2017.32.3", "2017.8.1", "2017.8.2", "2017.8.3", "2017.34.1", "2017.34.2", "2017.34.3", "2017.35.1", "2017.35.2", "2017.35.3", "2017.15.1", "2017.15.2", "2017.15.3", "2017.19.1", "2017.19.2", "2017.19.3", "2017.5.1", "2017.5.2", "2017.5.3", "2017.37.1", "2017.37.2", "2017.37.3", "2019.27.1", "2019.27.2", "2019.27.3", "2019.30.1", "2019.30.2", "2019.30.3", "2019.32.1", "2019.32.2", "2019.32.3", "2019.8.1", "2019.8.2", "2019.8.3", "2019.34.1", "2019.34.2", "2019.34.3", "2019.35.1", "2019.35.2", "2019.35.3", "2019.5.1", "2019.5.2", "2019.5.3", "2019.37.1", "2019.37.2", "2019.37.3"))


#How to rename dataframes if I want to break them up by DEM
mpq.1 <- subset(mpq1, DEM ==1) #1cm DEM
row.names(mpq.1) <- 1:nrow(mpq.1) #Changes the row names so that they are re-orderd 1-80

mpq.4 <- subset(mpq1, DEM ==4) #4cm DEM
row.names(mpq.4) <- 1:nrow(mpq.4) #Changes the row names so that they are re-orderd 1-80

mpq.8 <- subset(mpq1, DEM ==8) #8cm DEM
...
str(mpq1)
#Export csv file 
write.csv(mpq.1, "~/Desktop/GitHub/Bruce_MPQ_Analysis/Data/BaumLab_Complexity_1cm_Data_Clean.csv")
write.csv(mpq1, "~/Desktop/GitHub/Bruce_MPQ_Analysis/Data/BaumLab_Complexity_ALL_Data_Clean_updated.csv")
...
#Reorder dataframe
slope1 <- subset(slope, select = c("year", "hum_dist", "pub.site", "site", "ppq", "island.side", "region.3", "region.4", "region.full", "fractal.dimension"))
