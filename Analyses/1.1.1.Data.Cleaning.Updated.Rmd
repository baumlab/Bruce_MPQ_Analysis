...
# ggplot(range.final, aes(x = year, y=pro.range, fill=year)) + geom_boxplot() + theme_classic(base_size = 18) + xlab("") + ylab("Mean") + ggtitle("Profile Curvature") +  theme(legend.position="none") 
...
# ggplot(mpq, aes(x = year, y=pro.range.log, fill=year)) + geom_boxplot() + theme_classic(base_size = 18) + xlab("") + ylab("Mean") + ggtitle("Profile Curvature") +  theme(legend.position="none") 
# 
