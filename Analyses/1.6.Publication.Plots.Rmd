...
year.cols <-  c("#FDAE61", "#D73027", "#ABD9E9","#74ADD1","#4575B4") 
thesis.cols <-  c("#FDAE61", "#D73027", "#ABD9E9","#74ADD1","#4575B4") 
...
thesis.colscale<- scale_fill_manual(name="", values=thesis.cols, breaks=c("2015", "2016a", "2016b", "2017", "2019"))


ggplot(mpq.1cm, aes(y=vrm, x=hum_dist, fill= year)) + geom_boxplot() + year.colscale
ggplot(mpq.1cm, aes(y=vrm, x=hum_dist, fill= year)) + geom_boxplot() + thesis.colscale
...
#VRM
p.1 <- ggplot(mpq.1cm, aes(x = year, y=vrm, fill= year)) + geom_boxplot() + theme_classic(base_size = 16) + thesis.colscale  + labs(x="", y= "VRM") +  
...
#Surface Complexity
p.2 <- ggplot(mpq.1cm, aes(x = year, y=rug, fill= year)) + geom_boxplot() + theme_classic(base_size = 16) + thesis.colscale  + labs(x="", y= "Surface Complexity") +  
...
#Fractal Dimension
p.3 <- ggplot(mpq.1cm, aes(x = year, y=fractal.dimension, fill= year)) + geom_boxplot() + theme_classic(base_size = 16) + thesis.colscale  + labs(x="Year", y= "Fractal Dimension") +  
...
#Profile Curv Range
p.4 <- ggplot(mpq.1cm, aes(x = year, y=pro.range.log, fill= year)) + geom_boxplot() + theme_classic(base_size = 16) + thesis.colscale  + labs(x="", y= "Pro Range") +  
...
#Planform Curv range
p.5 <- ggplot(mpq.1cm, aes(x = year, y=plan.range.log, fill= year)) + geom_boxplot() + theme_classic(base_size = 16) + thesis.colscale  + labs(x="Year", y= "Plan Range") +  
...
```{r UPDATED habitat structure by year with legend}
#VRM
p.1 <- ggplot(mpq.1cm, aes(x = year, y=vrm, fill= year)) + geom_boxplot() + theme_classic(base_size = 16) + thesis.colscale  + labs(x="", y= "VRM") +  
  scale_y_continuous(breaks = c(0.02, 0.05, 0.08, 0.11), limits = c(0.02, 0.12)) + 
  #Annotate Tukey results
 ...
 #Annotate Multipanel plots
  annotate("label", 0.57 ,0.118, label = "i", fontface =2,family = "Times New Roman", size=4, fill = "gray90")
...
p.4 <- ggplot(mpq.1cm, aes(x = year, y=pro.range.log, fill= year)) + geom_boxplot() + theme_classic(base_size = 16) + thesis.colscale  + labs(x="", y= "Pro Range") +  
  ...
  theme(axis.title.x=element_blank(), 
        ...
        axis.text.y= element_text(family = "Times New Roman"),
         legend.position="none")+
 #Annotate Multipanel plots
  annotate("label", 0.57 ,14.445, label = "ii", fontface =2,family = "Times New Roman", size=4, fill = "gray90")
...
p.6 <- ggplot(cc, aes(x = time.interval, y=volume.change, fill= time)) + geom_boxplot()+ cc.colscale + labs(y = expression ("Δ Volume"~m^3), x = "Time Interval") +
  ...
  theme(axis.title.x=element_text(family = "Times New Roman"), 
        ...
        legend.position="none")+
 #Annotate Multipanel plots
  annotate("label", 0.505 ,0.91, label = "vi", fontface =2,family = "Times New Roman", size=4, fill = "gray90")
...
jpeg(filename = "UPDATED.Fig2.Metrics~Year.jpeg", width = 30, height = 20, units = "cm", pointsize = 15, quality = 100, res = 400)


grid.arrange(
  arrangeGrob(p.1 + theme(legend.position = "none"),p.2,p.3,p.4,p.5,p.6,  metric.legend,        ncol=2,nrow=4,
  layout_matrix = rbind(c(7,7),
                        c(1,4),
                        c(2,5),
                        c(3,6)),
  widths = c(1,1), heights = c(1.1,2,2,2)))

#Add legend text
grid.text("Expedition", x = unit(0.5, "npc"), y = unit(0.968, "npc"), gp = gpar(fontsize=15, fontface = "bold",family = "Times New Roman"))
...
mpq.1cm
#VRM
v.dem1 <- ggplot(mpq.1cm, aes(x = year, y=vrm, fill= year)) + geom_boxplot() + theme_classic(base_size = 16) + xlab("") + ylab("VRM") + ylim(0.01, 0.12) + thesis.colscale + theme(legend.position="none") + facet_wrap(~DEM_cm) + theme(legend.position = "none") + theme(axis.title.x=element_blank(), axis.text.x=element_blank())

v.dem4 <- ggplot(mpq.4cm, aes(x = year, y=vrm, fill= year)) + geom_boxplot() + theme_classic(base_size = 16) + xlab("") + ylab("") + ylim(0.01, 0.12) + thesis.colscale +  theme(legend.position="none") + facet_wrap(~DEM_cm) + theme(legend.position = "none")+ theme(axis.title.x=element_blank(), axis.text.x=element_blank())

v.dem8 <- ggplot(mpq.8cm, aes(x = year, y=vrm, fill= year)) + geom_boxplot() + theme_classic(base_size = 16) + xlab("") + ylab("") + ylim(0.01, 0.12) + thesis.colscale +  theme(legend.position="none") + facet_wrap(~DEM_cm) +  theme_classic(base_size = 16) + theme(legend.position = "none")+ theme(axis.title.x=element_blank(), axis.text.x=element_blank())


#Surface Complexity
r.dem1 <-ggplot(mpq.1cm, aes(x= year, y= rug, fill=year)) + theme_classic(base_size = 16) +  theme(legend.position="none") + geom_boxplot() + xlab("") + ylab("Surface Complexity") + thesis.colscale +  theme(legend.position="none") + ylim(1, 2.8) + theme_classic(base_size = 16) + theme(legend.position = "none")+ theme(axis.title.x=element_blank(), axis.text.x=element_blank())

r.dem4 <- ggplot(mpq.4cm, aes(x= year, y= rug, fill=year)) + theme_classic(base_size = 16) +  theme(legend.position="none") + geom_boxplot() + xlab("") + ylab("") + thesis.colscale +  theme(legend.position="none") + ylim(1, 2.8) +  theme_classic(base_size = 16) + theme(legend.position = "none")+ theme(axis.title.x=element_blank(), axis.text.x=element_blank())

r.dem8 <- ggplot(mpq.8cm, aes(x= year, y= rug, fill=year)) + theme_classic(base_size = 16) +  theme(legend.position="none") + geom_boxplot() + xlab("") + ylab("") + thesis.colscale +  theme(legend.position="none") + ylim(1, 2.8) + theme_classic(base_size = 16) + theme(legend.position = "none")+ theme(axis.title.x=element_blank(), axis.text.x=element_blank())

#Pro.Curve Range
pro.r.dem1 <- ggplot(mpq.1cm, aes(x = year, y=pro.range.log, fill= year)) + geom_boxplot() + theme_classic(base_size = 16) + xlab("") + ylab("Pro Range")  + thesis.colscale +  theme(legend.position="none") +  theme_classic(base_size = 16) + theme(legend.position = "none") + theme(axis.title.x=element_blank(), axis.text.x=element_blank())

pro.r.dem4 <- ggplot(mpq.4cm, aes(x = year, y=pro.range.log, fill= year)) + geom_boxplot() + theme_classic(base_size = 16) + xlab("") + ylab("")  + thesis.colscale +  theme(legend.position="none") + theme_classic(base_size = 16) + theme(legend.position = "none") + theme(axis.title.x=element_blank(), axis.text.x=element_blank())

pro.r.dem8 <- ggplot(mpq.8cm, aes(x = year, y=pro.range.log, fill= year)) + geom_boxplot() + theme_classic(base_size = 16) + xlab("") + ylab("") + thesis.colscale +  theme(legend.position="none") +  theme_classic(base_size = 16) + theme(legend.position = "none")+ theme(axis.title.x=element_blank(), axis.text.x=element_blank())


#Plan Curve Range
plan.r.dem1 <-ggplot(mpq.1cm, aes(x= year, y= plan.range.log, fill=year)) + theme_classic(base_size = 16) +  theme(legend.position="none") + geom_boxplot() + xlab("") + ylab("Plan Range") + thesis.colscale +  theme(legend.position="none")  + theme_classic(base_size = 16) + theme(legend.position = "none")

plan.r.dem4 <- ggplot(mpq.4cm, aes(x= year, y= plan.range.log, fill=year)) + theme_classic(base_size = 16) +  theme(legend.position="none") + geom_boxplot() + xlab("") + ylab("") + thesis.colscale +  theme(legend.position="none")  +  theme_classic(base_size = 16) + theme(legend.position = "none") 

plan.r.dem8 <- ggplot(mpq.8cm, aes(x= year, y= plan.range.log, fill=year)) + theme_classic(base_size = 16) +  theme(legend.position="none") + geom_boxplot() + xlab("") + ylab("") + thesis.colscale +  theme(legend.position="none") + theme_classic(base_size = 16) + theme(legend.position = "none")
...
```{r UPDATED metrics across DEM complexity changes , echo=FALSE}
#Add collumn to use as headers for facet_wrap
mpq.1cm$DEM_cm <- "1.0 cm"
mpq.4cm$DEM_cm <- "4.0 cm"
mpq.8cm$DEM_cm <- "8.0 cm"
...
mpq.1cm
#VRM
v.dem1 <- ggplot(mpq.1cm, aes(x = year, y=vrm, fill= year)) + geom_boxplot() + theme_classic(base_size = 13) + xlab("") + ylab("VRM") + ylim(0.01, 0.12) + thesis.colscale + theme(legend.position="none") + facet_wrap(~DEM_cm) + theme(legend.position = "none") + theme(axis.title.x=element_blank(), axis.text.x=element_blank())

v.dem4 <- ggplot(mpq.4cm, aes(x = year, y=vrm, fill= year)) + geom_boxplot() + theme_classic(base_size = 13) + xlab("") + ylab("") + ylim(0.01, 0.12) + thesis.colscale +  theme(legend.position="none") + facet_wrap(~DEM_cm) + theme(legend.position = "none")+ theme(axis.title.x=element_blank(), axis.text.x=element_blank())

v.dem8 <- ggplot(mpq.8cm, aes(x = year, y=vrm, fill= year)) + geom_boxplot() + theme_classic(base_size = 13) + xlab("") + ylab("") + ylim(0.01, 0.12) + thesis.colscale +  theme(legend.position="none") + facet_wrap(~DEM_cm)  + theme(legend.position = "none")+ theme(axis.title.x=element_blank(), axis.text.x=element_blank())


#Surface Complexity
r.dem1 <-ggplot(mpq.1cm, aes(x= year, y= rug, fill=year)) + theme_classic(base_size = 13) +  theme(legend.position="none") + geom_boxplot() + xlab("") + ylab("Surface Complexity") + thesis.colscale +  
  scale_y_continuous(breaks = c(1.200, 1.600, 2.000, 2.400, 2.800), limits = c(1.2, 2.8), labels=c("1.200", "1.600", "2.000", "2.400", "2.800")) + theme(legend.position="none") + theme(legend.position = "none")+ theme(axis.title.x=element_blank(), axis.text.x=element_blank())

r.dem4 <- ggplot(mpq.4cm, aes(x= year, y= rug, fill=year)) + theme_classic(base_size = 13) +  theme(legend.position="none") + geom_boxplot() + xlab("") + ylab("") + thesis.colscale +  theme(legend.position="none") +  
  scale_y_continuous(breaks = c(1.200, 1.4, 1.600, 1.8, 2.000), limits = c(1.2, 2.0), labels=c("1.200", "1.400", "1.600", "1.800", "2.000")) + theme(legend.position = "none")+ theme(axis.title.x=element_blank(), axis.text.x=element_blank())

r.dem8 <- ggplot(mpq.8cm, aes(x= year, y= rug, fill=year)) + theme_classic(base_size = 13) +  theme(legend.position="none") + geom_boxplot() + xlab("") + ylab("") + thesis.colscale +  theme(legend.position="none") +  
  scale_y_continuous(breaks = c(1.150, 1.250, 1.35, 1.45, 1.55), limits = c(1.15, 1.55), labels=c("1.150", "1.250", "1.350", "1.450", "1.550")) + theme(legend.position = "none")+ theme(axis.title.x=element_blank(), axis.text.x=element_blank())

#Pro.Curve Range
pro.r.dem1 <- ggplot(mpq.1cm, aes(x = year, y=pro.range.log, fill= year)) + geom_boxplot() + theme_classic(base_size = 13) + xlab("") + ylab("Pro Range")  + thesis.colscale +
  scale_y_continuous(breaks = c(12.5, 13, 13.5, 14, 14.5, 15), limits = c(12.5, 14.5), labels = c("12.50", "13.00", "13.50", "14.00", "14.50", "15.00")) +
  theme(legend.position="none")  + theme(legend.position = "none") + theme(axis.title.x=element_blank(), axis.text.x=element_blank())

pro.r.dem4 <- ggplot(mpq.4cm, aes(x = year, y=pro.range.log, fill= year)) + geom_boxplot() + theme_classic(base_size = 13) + xlab("") + ylab("")  + thesis.colscale +
  scale_y_continuous(breaks = c(9.5, 10, 10.5, 11, 11.5), limits = c(9.4, 11.6), labels = c("9.500", "10.00", "10.50", "11.00", "11.50"))  +  theme(legend.position="none") + theme(legend.position = "none") + theme(axis.title.x=element_blank(), axis.text.x=element_blank())

pro.r.dem8 <- ggplot(mpq.8cm, aes(x = year, y=pro.range.log, fill= year)) + geom_boxplot() + theme_classic(base_size = 13) + xlab("") + ylab("") + thesis.colscale +
  scale_y_continuous(breaks = c(8, 8.5, 9, 9.5, 10), limits = c(7.9, 10.1), labels = c("8.000", "8.500", "9.000", "9.500", "10.00")) +  theme(legend.position="none") + theme(legend.position = "none")+ theme(axis.title.x=element_blank(), axis.text.x=element_blank())


#Plan Curve Range
plan.r.dem1 <-ggplot(mpq.1cm, aes(x= year, y= plan.range.log, fill=year)) + theme_classic(base_size = 13) +  theme(legend.position="none") + geom_boxplot() + xlab("") + ylab("Plan Range") + thesis.colscale +  
  scale_y_continuous(breaks = c(11.85, 12.45, 13.05, 13.65, 14.25), limits = c(11.75, 14.5), labels = c("11.85", "12.45", "13.05", "13.65", "14.25")) + 
  theme(legend.position="none")  + theme(legend.position = "none")

plan.r.dem4 <- ggplot(mpq.4cm, aes(x= year, y= plan.range.log, fill=year)) + theme_classic(base_size = 13) +  theme(legend.position="none") + geom_boxplot() + xlab("") + ylab("") + thesis.colscale +  
  scale_y_continuous(breaks = c(9.500, 10.00, 10.50, 11.00, 11.50), limits = c(9.4, 11.6), labels = c("9.500", "10.00", "10.50", "11.00", "11.50"))+  theme(legend.position="none")  + theme(legend.position = "none") 

plan.r.dem8 <- ggplot(mpq.8cm, aes(x= year, y= plan.range.log, fill=year)) + theme_classic(base_size = 13) +  theme(legend.position="none") + geom_boxplot() + xlab("") + ylab("") + thesis.colscale +  
  scale_y_continuous(breaks = c(8.0, 8.5, 9.0, 9.5, 10.00), limits = c(7.9, 10.1), labels = c("8.000", "8.500", "9.000", "9.500", "10.00"))+  theme(legend.position="none") + theme(legend.position = "none")
...
#Make all indivdiual plots
vrm.int <- grid.arrange(v.dem1, v.dem4, v.dem8, ncol=3,nrow=1)
sc.int <- grid.arrange(r.dem1, r.dem4, r.dem8, ncol=3,nrow=1)
pro.int <- grid.arrange(pro.r.dem1, pro.r.dem4, pro.r.dem8, ncol=3,nrow=1)
plan.int <- grid.arrange(plan.r.dem1, plan.r.dem4, plan.r.dem8, ncol=3,nrow=1)

#Export as nice figure with correct resolution
jpeg(filename = "UPDATED.Fig3.Metrics~Resolution.jpeg", width = 30, height = 20, units = "cm", pointsize = 15, quality = 100, res = 400)


#Merge all plots together
grid.arrange(metric.legend, vrm.int, sc.int, pro.int, plan.int, ncol=1, nrow=5,
               widths = c(1), heights = c(1.1,1.9,1.8,1.8,2.2))

#Add legend text
grid.text("Expedition", x = unit(0.5, "npc"), y = unit(0.982, "npc"), gp = gpar(fontsize=15, fontface = "bold",family = "Times New Roman"))

#Add yearly significance stars
#1.0cm Resolution
grid.text("*", x = unit(0.31, "npc"), y = unit(0.22, "npc"), gp = gpar(fontsize=40, fontface = "bold",family = "Times New Roman", col = "forestgreen")) #Plan Curv

grid.text("*", x = unit(0.31, "npc"), y = unit(0.635, "npc"), gp = gpar(fontsize=40, fontface = "bold",family = "Times New Roman", col = "forestgreen")) #SC

grid.text("*", x = unit(0.31, "npc"), y = unit(0.795, "npc"), gp = gpar(fontsize=40, fontface = "bold",family = "Times New Roman", col = "forestgreen")) #VRM


#4.0cm Resolution
grid.text("*", x = unit(0.645, "npc"), y = unit(0.22, "npc"), gp = gpar(fontsize=40, fontface = "bold",family = "Times New Roman", col = "forestgreen")) #Plan Curv

grid.text("*", x = unit(0.645, "npc"), y = unit(0.795, "npc"), gp = gpar(fontsize=40, fontface = "bold",family = "Times New Roman", col = "forestgreen")) #VRM


#8.0cm Resolution
grid.text("*", x = unit(0.975, "npc"), y = unit(0.22, "npc"), gp = gpar(fontsize=40, fontface = "bold",family = "Times New Roman", col = "forestgreen")) #Plan Curv
...
```{r OLD- from thesis submission- predicted values plot}
#1. Assign years to a color scale
# year.cols <-  c("#FDAE61", "#D73027", "#E0F3F8", "#ABD9E9", "#74ADD1") 
# thesis.colscale<- scale_fill_manual(name="", values=year.cols, breaks=c("2015", "2016a", "2016b", "2017", "2019"))
...
v <- ggplot(vrm.predict2, aes(x = sqrt.hdist.cont, y = vrm, color = year)) +
  ...
  theme_classic(base_size = 16)  + thesis.colscale + 
  scale_color_manual(values=c("#ffffbf", "#d73027", "#f46d43", "#abd9e9", "#74add1", "#313695"), labels = c("May 2015", "March 2016", "Nov 2016", "July 2017", "July 2019")) + 
  theme(axis.title.x=element_blank(), axis.title.y = element_text(family = "Times New Roman"),
        axis.text.x=element_blank(), axis.text.y= element_text(family = "Times New Roman"),
...
```{r Attempt 4 to fix predicted values plot}
## VRM
set.seed(2)
vrm6 <- lm(vrm ~ year * sqrt.hdist.cont + island.side, data = mpq.1cm)
...
v <- ggplot(vrm.predict2, aes(x = sqrt.hdist.cont, y = vrm, color = year)) +
  geom_ribbon( aes(ymin = lwr, ymax = upr, fill = year, color = NULL), alpha = .15) + 
  guides(fill="none") + geom_line( aes(y = fit), size = 1.2)+ 
  labs(y ="VRM", color="") + 
  theme_classic(base_size = 16)  + thesis.colscale + 
  scale_color_manual(values=c("#FDAE61", "#D73027", "#ABD9E9","#74ADD1","#4575B4"), labels = c("May 2015", "March 2016", "Nov 2016", "July 2017", "July 2019")) + 
  theme(axis.title.x=element_blank(), 
        axis.title.y = element_text(family = "Times New Roman"),
        axis.text.x=element_blank(), 
        axis.text.y= element_text(family = "Times New Roman"),
        ...
        legend.background = element_rect(fill="grey90",
                                  ...
                                  colour ="black"),
        legend.text = element_text(family = "Times New Roman")) + 
  scale_fill_manual(name = "", values = year.cols, labels = c("May 2015","March 2016", "November 2016", "July 2017",  "July 2019")) + guides(color = guide_legend(nrow = 3)) +
   scale_y_continuous(breaks = c(0.02, .04, 0.06, 0.08), limits = c(0.02, 0.08), labels = c("0.025", "0.040", "0.055 ", "0.070"))
...
sc <- ggplot(rug.predict2, aes(x = sqrt.hdist.cont, y = rug, color = year)) +
  ...
  theme(axis.title.x=element_blank(), 
        ...
        axis.ticks.x = element_blank(),
        legend.position = "none") +   
  scale_y_continuous(breaks = c(1.4, 1.6, 1.8, 2.0), limits = c(1.3, 2.1), labels = c("  1.40 ", "  1.60 ", "  1.80 ", "  2.00 "))
...
f <- ggplot(frac.predict2, aes(x = sqrt.hdist.cont, y = rug, color = year)) +
  ...
  theme(axis.title.x = element_text(family = "Times New Roman"),
        ...
        axis.ticks.x = element_blank(),
        legend.position = "none") +
 scale_y_continuous(breaks = c(2.10, 2.12, 2.14, 2.16, 2.18, 2.2, 2.22), limits = c(2.095, 2.22), labels = c("  2.10 ", "  2.12 ", "  2.14 ", "  2.16 ", "  2.18 ", "  2.20 ", "  2.22 "))
...
#Export as nice figure with correct resolution
#2. Arrange all together
jpeg(filename = "Fig4.Year*dist.predictive.plots.jpeg", width = 30, height = 20, units = "cm", pointsize = 15, quality = 100, res = 400)
...
grid.text("*", x = unit(0.45, "npc"), y = unit(0.95, "npc"), gp = gpar(fontsize=40, fontface = "bold",family = "Times New Roman", col = "forestgreen")) #VRM
...
```{r UPDATED habitat structure by disturbance}
#VRM
p.h.1 <- ggplot(mpq.1cm, aes(x = hdist, y=vrm, fill= year))  + 
  geom_boxplot() + theme_classic(base_size = 16) + 
  labs(x = "", y = "VRM") +  
  ...
  legend.background = element_rect(fill="grey90",
                                  ...
                                  colour ="black"),
  legend.text = element_text(family = "Times New Roman")) + 
  scale_fill_manual(name = "", values = thesis.cols, labels = c("May 2015","March 2016", "November 2016", "July 2017",  "July 2019")) +
   #Annotate Multipanel plots
   annotate("label", 0.5 ,0.116, label = "i", fontface =2,family = "Times New Roman", size=4, fill = "gray90")
...
p.h.2 <- ggplot(mpq.1cm, aes(x = hdist, y=rug, fill = year)) + 
  geom_boxplot() + theme_classic(base_size = 16) + 
  labs(x="", y = "Surface Complexity") + thesis.colscale +  
    scale_y_continuous(breaks = c(1.2, 1.6, 2.0, 2.4, 2.8), limits = c(1.2, 2.81), labels = c("1.20", "1.60", "2.00", "2.40", "2.80"))+  
theme(axis.title.x=element_blank(), 
      axis.title.y = element_text(family = "Times New Roman"),
      axis.text.x=element_blank(), 
      ...
      legend.position = "none") +  
 #Annotate Tukey results/# of each plot in the multipanel 
  annotate("label", 0.52 ,2.78, label = "iii", fontface =2,family = "Times New Roman", size=4, fill = "gray90")


#Fractal Dimension
p.h.3 <- ggplot(mpq.1cm, aes(x = hdist, y=fractal.dimension, fill=year)) + 
  geom_boxplot() + theme_classic(base_size = 16) + 
  labs(x="Human Disturbance", y="Fractal Dimension") + thesis.colscale +  
    scale_y_continuous(breaks = c(2.09, 2.15, 2.21, 2.27, 2.33), limits = c(2.086, 2.332)) + 
  theme(axis.title.x=element_text(family = "Times New Roman"), 
        axis.title.y = element_text(family = "Times New Roman"),
        axis.text.x=element_text(family = "Times New Roman"), 
        ...
        legend.position = "none") +  
 #Annotate Tukey results/# of each plot in the multipanel 
  annotate("label", 0.5 ,2.323, label = "v", fontface =2,family = "Times New Roman", size=4, fill = "gray90")
...
theme(axis.title.x=element_text(family = "Times New Roman"), 
      ...
      legend.position = "none")  +
 #Annotate Tukey results/# of each plot in the multipanel 
  annotate("label", 0.52 ,0.898, label = "vi", fontface =2,family = "Times New Roman", size=4, fill = "gray90")


#Profile Curv Range
p.h.5 <- ggplot(mpq.1cm, aes(x = hdist, y=pro.range.log, fill = year)) + 
  geom_boxplot() + theme_classic(base_size = 16) + 
  labs(x= "", y= "Pro Range") + thesis.colscale +  
  scale_y_continuous(breaks = c(12.5, 13, 13.5, 14, 14.5, 15), limits = c(12.5, 14.5), labels =c("12.50", "13.00", "13.50", "14.00", "14.50", "15.00"))+
  theme(axis.title.x=element_blank(), 
        axis.title.y = element_text(family = "Times New Roman"),
        axis.text.x=element_blank(), 
        ...
        legend.position = "none") +  
   #Annotate # of each plot in the multipanel 
  annotate("label", 0.52 ,14.45, label = "ii", fontface =2,family = "Times New Roman", size=4, fill = "gray90")
...
p.h.6 <- ggplot(mpq.1cm, aes(x = hdist, y=plan.range.log, fill = year)) + 
  geom_boxplot() + theme_classic(base_size = 16) + 
  labs(x="Year", y="Plan Range") + thesis.colscale +  
  scale_y_continuous(breaks = c(11.9, 12.4, 12.9, 13.4, 13.9, 14.3), limits = c(11.9, 14.3), labels =c("11.90", "12.40", "12.90", "13.40", "13.90", "14.30"))+
  theme(axis.title.x=element_blank(), 
        axis.title.y = element_text(family = "Times New Roman"),
        axis.text.x=element_blank(), 
        axis.text.y= element_text(family = "Times New Roman"),
        legend.position = "none") +  
   #Annotate Tukey results/# of each plot in the multipanel 
  annotate("label", 0.52 ,14.25, label = "iv", fontface =2,family = "Times New Roman", size=4, fill = "gray90")
...
disturbance.legend <- p_legend(p.h.1) 
...
# #Export as nice figure with correct resolution
jpeg(filename = "ThesisFig3.Metrics~Hdist.jpeg", width = 30, height = 20, units = "cm", pointsize = 15, quality = 100, res = 400)

grid.arrange(
  arrangeGrob(p.h.1 + theme(legend.position = "none"),p.h.2,p.h.3,p.h.4,p.h.5,p.h.6,  disturbance.legend,        ncol=2,nrow=4,
  layout_matrix = rbind(c(7,7),
                        c(1,5),
                        c(2,6),
                        c(3,4)),
...
grid.text("Expedition", x = unit(0.5, "npc"), y = unit(0.97, "npc"), gp = gpar(fontsize=15, fontface = "bold",family = "Times New Roman"))

#Add green stars for hdist significance
grid.text("*", x = unit(0.45, "npc"), y = unit(0.8, "npc"), gp = gpar(fontsize=40, fontface = "bold",family = "Times New Roman", col = "forestgreen")) #VRM

grid.text("*", x = unit(0.45, "npc"), y = unit(0.53, "npc"), gp = gpar(fontsize=40, fontface = "bold",family = "Times New Roman", col = "forestgreen")) #SC

grid.text("*", x = unit(0.45, "npc"), y = unit(0.25, "npc"), gp = gpar(fontsize=40, fontface = "bold",family = "Times New Roman", col = "forestgreen")) #Frac

grid.text("*", x = unit(0.95, "npc"), y = unit(0.8, "npc"), gp = gpar(fontsize=40, fontface = "bold",family = "Times New Roman", col = "forestgreen")) #Pro

grid.text("*", x = unit(0.95, "npc"), y = unit(0.53, "npc"), gp = gpar(fontsize=40, fontface = "bold",family = "Times New Roman", col = "forestgreen")) #Plan
