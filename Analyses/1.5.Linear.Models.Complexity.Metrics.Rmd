...
#Variance is super low with the site intercept random effect ---> Perhaps means we can leave without?

AIC(vrm1, vrm2, vrm6, vrm10, vrm19, vrm20) #Models still fit better with site as a random effect
...
anova(rug13, rug14, rug15, rug16) #this says rug13 firts best (13<15<14<16)
...
#Results of best fitting models
summary(frac19)
anova(frac17,frac18,frac19, frac20) #States frac19 as best fit 
...
**frac ~ year * hum_dist + region4** 

**frac ~ year * hum_dist + island.side** 

**frac ~ year * sqrt.hdist.cont + region4 **
...
AIC(hab.vol13, hab.vol14, hab.vol15) #hab.vol14 <13<15 best fit
...
anova(hab.vol13, hab.vol14, hab.vol15) #this says hab.vol14 fits best (14<13<15)
...
AIC(hab.vol17, hab.vol18, hab.vol19) #hab.vol18 best fit

#Results of best fitting models
anova(hab.vol17,hab.vol18,hab.vol19) #States hab.vol18 as best fit (18<17<19)

#Combine all together
AIC(hab.vol13, hab.vol14, hab.vol15, hab.vol17, hab.vol18, hab.vol19) #hab.vol14 best fit


#Results
# Interaction between timepoint and human disturbance (which Jen did) doesn't make the models fit better
# Best fitting model has no region values within it (with continuous human disturbance model slightly better than categorical one)
