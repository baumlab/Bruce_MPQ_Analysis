...
vrm8 <- lm(vrm~year*hum_dist + region.3, data = mpq)
...
vrm10  <- lm(vrm ~ year + sqrt.hdist.cont + region.3, data = mpq)
...
vrm14 <- lmer(vrm~year + sqrt.hdist.cont + region.3 + (1|site), data = mpq)
...
vrm18 <- lmer(vrm~year * sqrt.hdist.cont + region.3 + (1|site), data = mpq)
...
rug6 <- lm(rug~ year + hum_dist + region.3, data = mpq)
rug7 <- lm(rug ~ year*hum_dist + island.side, data = mpq)
rug8 <- lm(rug~year*hum_dist + region.3, data = mpq)
...
rug10  <- lm(rug ~ year + sqrt.hdist.cont + region.3, data = mpq)
rug11 <- lm(rug ~ year*sqrt.hdist.cont + island.side, data = mpq)
rug12 <- lm(rug ~ year*sqrt.hdist.cont + region.3, data = mpq)
...
rug14 <- lmer(rug~year + sqrt.hdist.cont + region.3 + (1|site), data = mpq)
...
rug18 <- lmer(rug~year * sqrt.hdist.cont + region.3 + (1|site), data = mpq)
...
```{r frac not normal, echo=FALSE}
#Data is not normal
ggplot(frac, aes(x=frac)) + 
 geom_histogram(aes(y=..density..), colour="black", fill="white", bins= 30)+
 geom_density(alpha=.2, fill="#FF6666") + labs(title="Looks Normally Distributed",x="Fractal Dimension", y = "Density")
...
ggplot(cc, aes(x=hab.vol)) + 
 geom_histogram(aes(y=..density..), colour="black", fill="white", bins= 30)+
 geom_density(alpha=.2, fill="#FF6666") + labs(title="Or is it normal enough? Any suggestions?",x="Volumetric Change (m^3)", y = "Density")
...
# 5. Curvature Range Data 

## Profile Curvature Distributions {.tabset}
### Raw Data
...
qqnorm(mpq$vrm.range, pch = 1, frame = FALSE)
qqline(mpq$vrm.range, col = "steelblue", lwd = 2)
```

### Square Root Transformed
```{r sqrt pro curv, echo=FALSE}
#Transform the data
mpq$pro.range.t <- 1
mpq$pro.range.t <- sqrt(mpq$pro.range)
hist(mpq$pro.range.t)
lmv2 <- lm(pro.range.t ~ year, data = mpq)
plot(lmv2)


# 
# qqnorm(mpq$pro.range.t, pch = 1, frame = FALSE)
# qqline(mpq$pro.range.t, col = "steelblue", lwd = 2)
# 
...
### Log10 Transformed
```{r pro curv log transformed, echo=FALSE}
#Transform the data
mpq$pro.range.t <- log10(mpq$pro.range)
hist(mpq$pro.range.t)
lmv2 <- lm(pro.range.t ~ year, data = mpq)
plot(lmv2)
...
### Inverse Transformed (1/X)
```{r inverse transform, echo=FALSE}
#Transform the data
mpq$pro.range.t <- 1
mpq$pro.range.t <- 1/(mpq$pro.range)
hist(mpq$pro.range.t)
lmv2 <- lm(pro.range.t ~ year, data = mpq)
plot(lmv2)
...
## Planform Curvature Distributions {.tabset}

### Raw Data
```{r plan raw pro curv distribution, echo=FALSE}

hist(mpq$plan.range)
lmv3 <- lm(plan.range ~ year, data = mpq)
plot(lmv3)

# qqnorm(mpq$plan.range, pch = 1, frame = FALSE)
# qqline(mpq$plan.range, col = "steelblue", lwd = 2)
```

### Square Root Transformed
```{r plan sqrt pro curv, echo=FALSE}
#Transform the data
mpq$plan.range.t <- 1
mpq$plan.range.t <- sqrt(mpq$plan.range)
hist(mpq$plan.range.t)
lmv4 <- lm(plan.range.t ~ year, data = mpq)
plot(lmv4)
# 
# qqnorm(mpq$plan.range.t, pch = 1, frame = FALSE)
# qqline(mpq$plan.range.t, col = "steelblue", lwd = 2)
...
### Log10 Transformed
```{r plan curv log transformed, echo=FALSE}
#Transform the data
mpq$plan.range.t <- log10(mpq$plan.range)
hist(mpq$plan.range.t)
lmv4 <- lm(plan.range.t ~ year, data = mpq)
plot(lmv4)
...
### Inverse Transformed (1/X)
```{r plan inverse transform, echo=FALSE}
#Transform the data
mpq$plan.range.t <- 1/(mpq$plan.range)
hist(mpq$plan.range.t)
lmv4 <- lm(plan.range.t ~ year, data = mpq)
plot(lmv4)
...
```{r vrm range distributon, eval=FALSE, include=FALSE}
hist(mpq$vrm.range)
lmv1 <- lm(vrm.range ~ year, data = mpq)
plot(lmv1)
...
#Transform the data
mpq$vrm.range.t <- 1
mpq$vrm.range.t <- 1/(mpq$vrm.range)
hist(mpq$vrm.range.t)

qqnorm(mpq$vrm.range.t, pch = 1, frame = FALSE)
qqline(mpq$vrm.range.t, col = "steelblue", lwd = 2)


lmv2 <- lm(vrm.range.t ~ year, data = mpq)
plot(lmv2)
