...
ggplot(mpq_arc, aes(x= Site.Processor, y= PlotArea, fill=Processor)) +  geom_bar(stat = 'identity')

```

## Surface Rugosity Comparissons
```{r Rugosity KB vs. JM, echo = FALSE}
ggplot(mpq_arc, aes(x= Site.Processor, y= rugosity, fill=Processor)) +  geom_bar(stat = 'identity')

```

## Terrain Ruggedness Comparissons
```{r TR KB Vs. JM, echo=FALSE}
ggplot(mpq_arc, aes(x= Site.Processor, y= terrain_rug, fill=Processor)) +  geom_bar(stat = 'identity')
...
ggplot(mpq_arc, aes(x= Site.Processor, y= Curvature, fill=Processor)) +  geom_bar(stat = 'identity')
